return { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    set('n', '<leader>ft', '<cmd>TodoTelescope<CR>', { desc = '[F]ind [T]odos' })
    set('n', '<leader>fo', builtin.oldfiles, { desc = '[F]ind Recent Files ("." for repeat)' })
    set('n', '<leader>f.', '<cmd>Telescope find_files hidden=true no_ignore=true<CR>', { desc = '[F]ind Hiden files' })
